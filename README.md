...
> Web-based DENR - Eastern Samar Chainsaw Management System Test Case Management Repository

* [Authentication Testing](Authentication-Testing)

  * [AUTH-0001: Authentication testing - Register Account](Authentication-Testing/AUTH-0001-register-account.md)
  * [AUTH-0002: Authentication testing - Login with Valid Account](Authentication-Testing/AUTH-0002-login-valid-account.md)
  * [AUTH-0003: Authentication testing - Login with Invalid Password](Authentication-Testing/AUTH-0003-login-invalid-password.md)
  * [AUTH-0004: Authentication testing - Logout Account](Authentication-Testing/AUTH-0004-logout-account.md)
  * [AUTH-0005: Authentication testing - Protected Dashboard Access](Authentication-Testing/AUTH-0005-protected-dashboard-access.md)

* [Dashboard Testing](Dashboard-Testing)

  * [DASH-0001: Dashboard testing - View Dashboard Overview](Dashboard-Testing/DASH-0001-view-dashboard-overview.md)
  * [DASH-0002: Dashboard testing - View Total Registrations](Dashboard-Testing/DASH-0002-view-total-registrations.md)
  * [DASH-0003: Dashboard testing - View Active and Expired Records](Dashboard-Testing/DASH-0003-view-active-expired-records.md)

* [Chainsaw Registration Testing](Chainsaw-Registration-Testing)
...
* [Chainsaw Records Testing](Chainsaw-Records-Testing)
  ...
  * [REC-0001: Records testing - View Chainsaw Records List](Chainsaw-Records-Testing/REC-0001-view-records-list.md)
  * [REC-0002: Records testing - Search Chainsaw Records](Chainsaw-Records-Testing/REC-0002-search-records.md)
  * [REC-0003: Records testing - Filter Chainsaw Records](Chainsaw-Records-Testing/REC-0003-filter-records.md)
...
* [Reports Testing](Reports-Testing)
  ...
  * [REP-0001: Reports testing - View Reports Page](Reports-Testing/REP-0001-view-reports-page.md)
  * [REP-0002: Reports testing - Verify Total Registration Count](Reports-Testing/REP-0002-verify-total-registration-count.md)
  * [REP-0003: Reports testing - Verify Active Permit Count](Reports-Testing/REP-0003-verify-active-permit-count.md)
  * [REP-0004: Reports testing - Verify Expired Permit Count](Reports-Testing/REP-0004-verify-expired-permit-count.md)
  * [REP-0005: Reports testing - View Reports Pie Graph](Reports-Testing/REP-0005-view-reports-pie-graph.md)
...
* [Responsive Design Testing](Responsive-Design-Testing)
  ...
  * [RES-0001: Responsive testing - Dashboard Mobile View](Responsive-Design-Testing/RES-0001-dashboard-mobile-view.md)
  * [RES-0002: Responsive testing - Registration Form Mobile View](Responsive-Design-Testing/RES-0002-registration-form-mobile-view.md)
  * [RES-0003: Responsive testing - Chainsaw Records Mobile View](Responsive-Design-Testing/RES-0003-records-mobile-view.md)
